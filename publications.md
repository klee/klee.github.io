...
2. [Server-side Verification of Client Behavior in Online Games](http://www.isoc.org/isoc/conferences/ndss/10/pdf/01.pdf)  
...
3. [KleeNet: Discovering Insidious Interaction Bugs in Wireless Sensor Networks Before Deployment](http://www.comsys.rwth-aachen.de/fileadmin/papers/2010/2010-04-ipsn-sasnauskas-KleeNet.pdf)  
...
4. [Execution Synthesis: A Technique for Automated Software Debugging](http://dslab.epfl.ch/pubs/esd.pdf)  
  Cristian Zamfir, George Candea  
  ACM SIGOPS/EuroSys European Conference on Computer Systems (EuroSys 2010)  
  April 13-16, 2010, Paris, France  

5. [Reverse Engineering of Binary Device Drivers with RevNIC](http://dslab.epfl.ch/pubs/revnic.pdf)  
  Vitaly Chipounov, George Candea  
  ACM SIGOPS/EuroSys European Conference on Computer Systems (EuroSys 2010)  
  April 13-16, 2010, Paris, France  

6. [Testing Closed-Source Binary Device Drivers with DDT](http://dslab.epfl.ch/pubs/ddt.pdf)  
...
7. [Stable Deterministic Multithreading through Schedule Memoization](http://rcs.cs.columbia.edu/papers/cui-tern-osdi10.pdf)  
...
8. [AEG: Automatic Exploit Generation](http://security.ece.cmu.edu/aeg/aeg-ndss-2011.pdf)  
...
10. [S2E: A Platform for In Vivo Multi-Path Analysis of Software Systems](http://dslab.epfl.ch/pubs/s2e.pdf?attredirects=0)  
...
11. [Parallel Symbolic Execution for Automated Real-World Software Testing](http://dslab.epfl.ch/pubs/cloud9.pdf?attredirects=0)  
...
12. [Symbolic Crosschecking of Floating-Point and SIMD Code](http://srg.doc.ic.ac.uk/publications/kleefp-eurosys-11.html)  
  Peter Collingbourne, Cristian Cadar, Paul H. J. Kelly  
  ACM SIGOPS/EuroSys European Conference on Computer Systems (EuroSys 2011)  
  April 10-13, 2011, Salzburg, Austria  

13. [Practical, Low-Effort Equivalence Verification of Real Code](http://keeda.stanford.edu/~daramos/papers/ucklee-cav-2011.pdf)  
  David Ramos, Dawson Engler  
  Computer Aided Verification (CAV 2011)  
  July 16-20, 2011, Snowbird, UT, USA  

14. [Scalable Symbolic Execution of Distributed Systems](http://www.comsys.rwth-aachen.de/fileadmin/papers/2011/2011-06-icdcs-sasnauskas-sde.pdf)  
...
15. [Efficient Deterministic Multithreading through Schedule Relaxation](http://rcs.cs.columbia.edu/papers/peregrine-sosp11.pdf)  
...
16. [KLOVER: A Symbolic Execution and Automatic Test Generation Tool for C++ Programs](http://www.cs.utah.edu/~ligd/publications/KLOVER-CAV11.pdf)  
...
17. [Symbolic Testing of OpenCL Code](http://srg.doc.ic.ac.uk/publications/kleecl-hvc-11.html)  
  Peter Collingbourne, Cristian Cadar, Paul H. J. Kelly  
  Haifa Verification Conference (HVC 2011)  
  December 6-8, 2011, Haifa, Israel  

18. [GKLEE: Concolic Verification and Test Generation for GPUs](http://www.cs.utah.edu/formal_verification/GKLEE/ppopp12-gklee-accepted-version.pdf)  
...
19. [make test-zesti: A Symbolic Execution Solution for Improving Regression Testing](http://srg.doc.ic.ac.uk/publications/zesti-icse-12.html)  
...
20. [BugRedux: Reproducing Field Failures for In-House Debugging](http://www.cc.gatech.edu/~orso/papers/jin.orso.ICSE12.pdf)  
  Wei Jin, Alessandro Orso  
  International Conference on Software Engineering (ICSE 2012)  
  June 2-9, 2012, Zurich, Switzerland  
  **BugRedux is available [here](http://www.cc.gatech.edu/~wjin6/mypage/bugredux.html).**  

21. [Efficient State Merging in Symbolic Execution](http://dslab.epfl.ch/pubs/stateMerging.pdf)  
  Volodymyr Kuznetsov, Johannes Kinder, Stefan Bucur, George Candea  
  Programming Language Design and Implementation (PLDI)  
  June 11-16, 2012, Beijing, China  

22. [High-Coverage Symbolic Patch Testing](http://srg.doc.ic.ac.uk/publications/highcovpatch-spin-12.html)  
  Paul Dan Marinescu, Cristian Cadar  
  SPIN Workshop on Model Checking of Software (SPIN 2012)  
  July 23-24, 2012, Oxford, UK   

23. [Checking Properties Described by State Machines: On Synergy of Instrumentation, Slicing, and Symbolic Execution](http://is.muni.cz/repo/984069/sse.pdf)  
...
24. [Automatic Detection of Floating-Point Exceptions](http://earlbarr.com/publications/ariadne.pdf)  
  Peter C. Rigby, Earl T. Barr, Christian Bird, Premkumar Devanbu, Daniel M. German  
  Principles of Programming Languages (POPL)  
  January 23-25, 2013, Rome, Italy  

25. [Symbiotic: Synergy of Instrumentation, Slicing, and Symbolic Execution (Competition Contribution)](http://is.muni.cz/repo/1078253/77950621.pdf)  
  Jiri Slaby, Jan Strejcek, Marek Trtík  
...
26. [Post-silicon Conformance Checking with Virtual Prototypes](http://web.cecs.pdx.edu/~leil/pub/Conformance.pdf)  
  Li Lei and Fei Xie and Kai Cong  
  Annual Design Automation Conference (DAC 2013)  
  June 1-5, 2013, San Francisco, CA, USA  

27. [Redundant State Detection for Dynamic Symbolic Execution](http://www.stanford.edu/~suhabe/atc13-bugrara.pdf)  
  Suhabe Bugrara, Dawson Engler  
  USENIX Annual Technical Conference (USENIX ATC 2013)  
  June 26-28, 2013, San Jose, California  

28. [KATCH: High-Coverage Testing of Software Patches](http://srg.doc.ic.ac.uk/publications/katch-fse-13.html)  
  Paul Dan Marinescu, Cristian Cadar  
...
If you have used and extended KLEE, please share your experience by having your paper listed here (email klee-dev-owner or [c.cadar@imperial.ac.uk](mailto:c.cadar@imperial.ac.uk)).
